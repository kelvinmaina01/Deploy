...
TRAIN_UNSLOTH = '''"""
Deploy Training Script - Unsloth LoRA Fine-Tuning
===================================================
Run: python train.py
...
print("="*60)
print("DEPLOY - UNSLOTH LORA TRAINING")
print("="*60)
...
EVAL_SCRIPT = '''"""
Deploy Evaluation Script - Test Your Fine-Tuned Model
========================================================
Run: python eval.py
"""
...
EXPORT_SCRIPT = '''"""
Deploy Export Script - Export Model to Various Formats
=========================================================
...
def _generate_requirements() -> str:
    ...
    return """# Deploy Training Requirements
# ================================
...
def _generate_readme(state: "DeployState") -> str:
    ...
    readme = f'''# Deploy Training Package

## Overview

This training package was generated by **[Deploy](https://github.com/riyanshibohra/Deploy)** using **Unsloth** for fast, memory-efficient LoRA fine-tuning.
...
- [Deploy GitHub](https://github.com/riyanshibohra/Deploy)
- [Unsloth GitHub](https://github.com/unslothai/unsloth)
- [HuggingFace PEFT](https://huggingface.co/docs/peft)
- [TRL Library](https://huggingface.co/docs/trl)

---
*Generated by [Deploy](https://github.com/riyanshibohra/Deploy) - Automated Fine-Tuning Pipeline*
'''
...
def generate_package(state: "DeployState") -> dict:
    """
    ...
    package_name = f"deploy_lora_{timestamp}"
