...
(function () {
    ...
    const savedTheme = localStorage.getItem('deploy-theme');
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (toggle) {
            toggle.addEventListener('click', () => {
                ...
                localStorage.setItem('deploy-theme', newTheme);
            });
        }
    });
})();
...
document.getElementById('openColabBtn')?.addEventListener('click', async () => {
    ...
    try {
        ...
        if (data.colab_url) {
            ...
            link.download = data.notebook_url.split('/').pop() || 'deploy_training.ipynb';
            ...
            // Make "Open Colab" button trigger download (no Gist URL available)
            const openColabBtn = document.getElementById('openColabBtn');
            if (openColabBtn) {
                openColabBtn.href = downloadUrl;
                openColabBtn.download = data.notebook_url.split('/').pop() || 'deploy_training.ipynb';
                openColabBtn.innerHTML = `
