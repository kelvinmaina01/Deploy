...
This training package was generated by **[TuneKit](https://github.com/riyanshibohra/TuneKit)** using **Unsloth** for fast, memory-efficient LoRA fine-tuning.
...
- [TuneKit GitHub](https://github.com/riyanshibohra/TuneKit)
- [Unsloth GitHub](https://github.com/unslothai/unsloth)
- [HuggingFace PEFT](https://huggingface.co/docs/peft)
- [TRL Library](https://huggingface.co/docs/trl)

---
*Generated by [TuneKit](https://github.com/riyanshibohra/TuneKit) - Automated Fine-Tuning Pipeline*
'''
